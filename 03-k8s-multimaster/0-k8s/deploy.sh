...
cd 03-k8s-multimaster/0-k8s/0-terraform
terraform init
...
ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i hosts 2-provisionar-k8s-master-auto-shell.yml -u ubuntu --private-key /var/lib/jenkins/treinamentoitau_mauricio2.pem